...
const VerticalVideoModal = ({ isOpen, onClose, video }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50">
      <div className="relative bg-black rounded-lg overflow-hidden" style={{ width: '380px', maxHeight: '99vh' }}>
        ...
        {/* Video Container - 9:16 aspect ratio for vertical video (shorts) */}
        <div className="relative bg-black" style={{ width: '100%', paddingBottom: '177.78%' }}>
          <iframe
