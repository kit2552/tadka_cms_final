...
const CreateAgentModal = ({ onClose, onSelect }) => {
  const agentTypes = [
    ...
    },
    {
      ...
      description: 'Scrape movie reviews from websites and use AI to create formatted reviews',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      type: 'ott_review',
      name: 'OTT Review Agent',
      description: 'Scrape OTT movie/web series reviews from Binged.com with rating and metadata',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
