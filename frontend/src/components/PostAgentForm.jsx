      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="p-6 space-y-4">
            ...
            {/* Common Fields - Content Settings - Hide for tadka_pics, video, tv_video, reality_show, ott_release, theater_release, movie_review, and ott_review agents */}
            {formData.agent_type !== 'tadka_pics' && formData.agent_type !== 'video' && formData.agent_type !== 'tv_video' && formData.agent_type !== 'reality_show' && formData.agent_type !== 'ott_release' && formData.agent_type !== 'theater_release' && formData.agent_type !== 'movie_review' && formData.agent_type !== 'ott_review' && (
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
...
5. Format: First line should be the title, then a blank line, then the content`
            ...
            {/* Content Workflow Section - Hide for tadka_pics, ott_release, theater_release, movie_review, and ott_review */}
            {formData.agent_type !== 'tadka_pics' && formData.agent_type !== 'ott_release' && formData.agent_type !== 'theater_release' && formData.agent_type !== 'movie_review' && formData.agent_type !== 'ott_review' && (
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
