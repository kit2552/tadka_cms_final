      ...
      <div className="max-w-5xl-plus mx-auto px-8 pb-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 lg:h-[calc(100vh-80px)]">
              ...
              <div className="space-y-6 mb-8">
                ...
                {hasContent(article.review_what_works) && (
                  <div className="mb-6">
                    ...
                    <div className="movie-review-content movie-review-numbered-list text-gray-900 leading-relaxed text-left" dangerouslySetInnerHTML={{ __html: stripLinkStyles(article.review_what_works) }} />
                  </div>
                )}
                ...
                {hasContent(article.review_what_doesnt_work) && (
                  <div className="mb-6">
                    ...
                    <div className="movie-review-content movie-review-numbered-list text-gray-900 leading-relaxed text-left" dangerouslySetInnerHTML={{ __html: stripLinkStyles(article.review_what_doesnt_work) }} />
                  </div>
                )}
          ...
          <div className="lg:col-span-2 border-t border-gray-300 lg:border-t-0 pt-2 lg:pt-0 lg:overflow-y-auto custom-scrollbar lg:h-full" style={{ paddingLeft: '0px', paddingRight: '4px' }}>
            ...
            {article.content_type !== 'movie_review' && article.content_type !== 'ott_review' && (article.comments_enabled !== false) && (
              <div className="mb-6" style={{ marginTop: '1rem' }}>
