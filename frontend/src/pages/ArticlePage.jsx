                  ...
                  return (
                    <div className="relative">
                      <div className="w-full h-96 overflow-hidden">
                        <img
                          src={typeof images[currentSlide] === 'string' ? images[currentSlide] : images[currentSlide].url}
                          alt={`${article.title} - Image ${currentSlide + 1}`}
                      ...
                      {images.length > 1 && (
                        <>
                          <button
                            ...
                            className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-3 rounded-full transition-all"
                          >
                            ‹
                          </button>
                          <button
                            onClick={() => setCurrentSlide((prev) => (prev === images.length - 1 ? 0 : prev + 1))}
                            className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-3 rounded-full transition-all"
                          >
                            ›
                          </button>
