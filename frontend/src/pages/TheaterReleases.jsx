      ...
      try {
        ...
        if (ottRegionalResponse.ok) {
          ...
          if (regionalResponse.ok) {
            ...
            setRegionalReleases(regionalData);
          }
        }
    ...
    return (
      <div className={`min-h-screen ${themeClasses.pageBackground} flex items-center justify-center`}>
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <h2 className={`text-2xl font-bold ${themeClasses.textPrimary} mb-2`}>Unable to Load Theater Releases</h2>
    ...
    <>
      ...
      <div className={`min-h-screen ${themeClasses.pageBackground}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8">
          ...
          {/* Theater Releases Section - 70% width */}
          <div className="lg:col-span-7 -mt-1">
            {/* Theater Releases Section Header - Sticky with filter and bottom border */}
...
export default TheaterReleases;