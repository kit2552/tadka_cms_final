  ...
  useEffect(() => {
    const fetchEventsInterviewsData = async () => {
      try {
        ...
        setError('Failed to load events & press meets. Please try again later.');
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className={`min-h-screen ${themeClasses.pageBackground} flex items-center justify-center`}>
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <h2 className={`text-2xl font-bold ${themeClasses.textPrimary} mb-2`}>Unable to Load Events & Press Meets</h2>
    ...
    <>
      ...
      <div className="max-w-5xl-plus mx-auto px-8 pb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:h-[calc(100vh-120px)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              {filteredArticles.length > 0 ? (
                ...
                <div className="col-span-full text-center py-8">
                  <p className="text-sm text-gray-400 mb-1">No {activeTab === 'bollywood' ? 'bollywood events & press meets' : 'events & press meets'} found</p>
          ...
          <div className="lg:col-span-3 border-t border-gray-300 lg:border-t-0 pt-2 lg:pt-1 lg:overflow-y-auto custom-scrollbar lg:h-full" style={{ paddingLeft: '0px', paddingRight: '4px' }}>
            {/* Related Articles Section Header - Sticky */}
            <div className={`sticky top-0 z-30 border-b-2 border-gray-300 mb-3`} style={{ backgroundColor: 'rgb(249 250 251 / var(--tw-bg-opacity, 1))' }}>
              <div className="pl-0 pr-4 py-4">
                <div className="mb-2">
