                      ...
                      <div className="flex items-center gap-3">
                        {connectionStatus === 'connected' && (
                          <>
                            ...
                            <div>
                              <span className="text-sm font-medium text-green-800">Connected to S3</span>
                              {awsConfig.last_test_time && (
                                <p className="text-xs text-green-600 mt-0.5">
                                  Last tested: {new Date(awsConfig.last_test_time).toLocaleString()}
                                </p>
                              )}
                            </div>
                          </>
                        ...
                        {connectionStatus === 'testing' && (
                          <>
                            ...
                            <span className="text-sm font-medium text-blue-800">Testing Connection...</span>
                          </>
                        )}
                        {connectionStatus === 'unknown' && (
                          <>
                            ...
                            <span className="text-sm font-medium text-gray-700">Connection Status Unknown</span>
                          </>
                        )}
                      </div>
                      {connectionStatus !== 'testing' && (
