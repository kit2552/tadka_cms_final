      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Get started by creating your first AI agent</p>
            <button
              onClick={() => setShowCreateModal(true)}
              ...
              <div key={agent.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-lg ${agent.is_active ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-400'}`}>
                      {getAgentTypeIcon(agent.agent_type)}
                    </div>
                    <div>
                      <h3 className="font-semibold text-gray-900">{agent.agent_name}</h3>
                      <p className="text-sm text-gray-500">{getAgentTypeName(agent.agent_type)}</p>
                    </div>
                  </div>
                  <button
                ...
                <div className="space-y-2 mb-4">
                  ...
                  {agent.topic && (
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-gray-600">{agent.topic}</span>
                    </div>
                  )}
                  {agent.target_state && (
                    <div className="flex items-center gap-2 text-sm">
