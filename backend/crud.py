...
def create_article(db, article: dict):
    ...
    article_doc = {
        ...
        "is_sponsored": article.get("is_sponsored", False),  # Not sponsored by default
        ...
        "review_producer": article.get("review_producer"),
        "review_music_director": article.get("review_music_director"),
        "review_dop": article.get("review_dop"),
        "review_editor": article.get("review_editor"),
        "review_banner": article.get("review_banner"),
