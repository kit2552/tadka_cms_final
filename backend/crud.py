...
def update_article_cms(db, article_id: int, article: dict):
    ...
    allowed_fields = [
        ...
        "states", "category", "content_type", "ad_type", "image", "image_gallery", 
        "gallery_id", "youtube_url", "tags", "artists", "movie_rating",
        "is_featured", "is_top_story", "top_story_duration_hours", "is_published", "is_scheduled", "scheduled_publish_at", "scheduled_timezone",
