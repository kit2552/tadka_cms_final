...
class YouTubeRSSService:
    ...
    def get_videos_for_agent(
        ...
        exclude_keywords = {
            ...
            'trending_videos': ['reaction', 'cover', 'karaoke', 'instrumental', 'scene', 'making', 'behind', 'dubbed', 'full movie', 'jukebox', 'scenes', 'comedy', 'best of', 'top 10', 'mashup', 'trailer', 'teaser', 'first look', 'glimpse', 'audio', '4k', '8k', 'remastered', 'restored'],
